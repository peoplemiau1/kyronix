...
static void test_mqtt_init_netif(struct netif *netif, const ip_addr_t *ip_addr,
...
static void test_mqtt_connection_cb(mqtt_client_t *client, void *arg,
...
START_TEST(basic_connect) {
    ...
    struct netif netif;
    err_t err;
    struct mqtt_connect_client_info_t client_info = { "dumm", NULL, NULL, 10, NULL, NULL, 0, 0, 0 };
    struct pbuf *p;
    ...
    err = mqtt_client_connect(client, &test_mqtt_remote_ip, 1234, test_mqtt_connection_cb, NULL,
                              &client_info);
